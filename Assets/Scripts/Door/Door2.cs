...
public class Door2 : MonoBehaviour
{
    ...
    public GameObject wavamanager1;//引用未启用的物体
    public WaveManager4 waveManager; // 引用WaveManager4脚本
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {    
            wavamanager1.SetActive(true);
            waveManager = FindObjectOfType<WaveManager4>();
            enemyRemainingCount = waveManager._enemyRemaingaAliveCount4;
